...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="d-flex">
            <a href="sair.php" class="btn me-5" style="background-color: black; color: white;">Sair</a>
        </div>
    </nav>
    <br>
    <?php
    ...
    <div class="box-search">
        ...
        <div class="d-flex" style="margin-left: 25px;">
            <a href="cadastrar.php" class="btn btn-success me-5">Cadastrar novo usuário</a>
        </div>
    </div>
    <div class="m-5">
